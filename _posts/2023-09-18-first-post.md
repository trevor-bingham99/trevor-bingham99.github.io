...
<img src="{{site.url}}/{{site.baseurl}}/assets/images/dic.jpg"/>In this simple example you can see the impact that being either discrete or continuous can have on the visualization in Tabluea. 