...
![Continuous Profit]({{site.url}}/{{site.baseurl}}/assets/images/cont.jpg)

Whereas changing the Profit metric to be a discrete variable changes the visualization to look like this:

![Discrete Profit]({{site.url}}/{{site.baseurl}}/assets/images/disc.jpg)
...
![Viz Options]({{site.url}}/{{site.baseurl}}/assets/images/show.jpg)
...
![Enhancement Options]({{site.url}}/{{site.baseurl}}/assets/images/options.jpg)
...
![Color Bar Chart]({{site.url}}/{{site.baseurl}}/assets/images/color.jpg)
